...
public class BlockstateExpansion extends BlockstateMaker implements IItemTextureProvider {
	...
	public BlockstateExpansion(String name, String folder, MaterialType type) {
		super(name, folder);
		this.type = type;
	}
	...
	protected String getVariantString(Properties prop) {
		...
		return super.getVariantString(prop) +
			"facing=north,machine_face=none,machine_parent=none," +
