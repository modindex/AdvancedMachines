...
public class BlockstateMaker {
	...
	public void makeBlock() throws IOException {
		File file = new File("..\\src\\main\\resources\\assets\\" + Reference.MODID + "\\models\\block\\" + name + ".json");
		file.createNewFile();
	...
	public void makeItems() throws IOException {
		File file = new File("..\\src\\main\\resources\\assets\\" + Reference.MODID + "\\models\\item\\" + name + ".json");
		file.createNewFile();
		FileWriter writer = new FileWriter(file, false);
		...
		writer.write(
			"        \"all\": \"" + Reference.MODID + ":blocks/" + getTextureFolder("north", new Properties(true, true, true, true, true, true)) + "/all\"\r\n"
		);
		writer.write("    }\r\n}");
		writer.close();
	}
	...
	public void make() throws IOException {
		...
		String start = "{\r\n" + 
			...
			"    \"forge_marker\": 1,\r\n" + 
			"    \"defaults\": {\r\n" + 
			"        \"model\": \"" + Reference.MODID + ":" + name + "\"\r\n" + 
			"    },\r\n" + 
			"    \"variants\": {\r\n";
			
		String end = "    }\r\n}";
		
		File file = new File("..\\src\\main\\resources\\assets\\" + Reference.MODID + "\\blockstates\\" + name + ".json");
		file.createNewFile();
		FileWriter writer = new FileWriter(file, false);
	...
	protected String makeEntry(Properties prop, boolean first) throws IOException {
		...
		ret += tab2 + "\"model\": \"" + Reference.MODID + ":" + name + "\",\r\n";
		ret += tab2 + "\"textures\": {\r\n";
		ret += tab3 + "\"down\": \"" + Reference.MODID + ":blocks/" + getTextureFolder("down", prop) + block.bottom.toString() + "\",\r\n";
		ret += tab3 + "\"east\": \"" + Reference.MODID + ":blocks/" + getTextureFolder("east", prop) + block.east.toString() + "\",\r\n";
		ret += tab3 + "\"north\": \"" + Reference.MODID + ":blocks/" + getTextureFolder("north", prop) + block.north.toString() + "\",\r\n";
		ret += tab3 + "\"south\": \"" + Reference.MODID + ":blocks/" + getTextureFolder("south", prop) + block.south.toString() + "\",\r\n";
		ret += tab3 + "\"up\": \"" + Reference.MODID + ":blocks/" + getTextureFolder("up", prop) + block.top.toString() + "\",\r\n";
		ret += tab3 + "\"west\": \"" + Reference.MODID + ":blocks/" + getTextureFolder("west", prop) + block.west.toString() + "\",\r\n";
		ret += tab3 + "\"particle\": \"" + Reference.MODID + ":blocks/" + getTextureFolder("particle", prop) + "all\"\r\n";
		ret += tab2 + "}\r\n";
