...
public class Reference {
	...
	// %1.13% Not Needed
	public static final String CLIENT = "jaminv.advancedmachines.init.InitProxyClient";
	public static final String SERVER = "jaminv.advancedmachines.init.InitProxyServer";
}
