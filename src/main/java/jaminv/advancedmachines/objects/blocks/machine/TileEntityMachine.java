...
public abstract class TileEntityMachine extends TileEntity implements ITickable, IHasGui, IMachineTE, IHasMetadata, IDirectional, ISyncSubject {
	...
	protected final MachineFluidHandler fluidtank = new MachineFluidHandler(ModConfig.general.defaultMachineFluidCapacity * MaterialExpansion.maxMultiplier,
	...
	public void setMeta(int meta) {
		...
		this.fluidtank.setFluidCapacity(ModConfig.general.defaultMachineFluidCapacity * getMultiplier());		
	}
