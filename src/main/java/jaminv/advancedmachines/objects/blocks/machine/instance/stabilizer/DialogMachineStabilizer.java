...
public class DialogMachineStabilizer extends DialogMachineBase {
	
	public static final LayoutManager layout = new LayoutManager()
		.addLayout(new InputLayout(GrinderManager.getRecipeManager(), 107, 37))
		.addLayout(new OutputLayout(152, 59))
		.addLayout(new OutputLayout(180, 59))
	...
	public DialogMachineStabilizer(ContainerMachine container, TileEntityMachineStabilizer te) {
		...
		this.addElement(new DialogFluid(53, 21, 16, 48, te.getFluidTank().getTank(0)));
