 ...
 */
public interface MachineController extends DoesProcess {
	public interface SubController {
		public void setController(@Nullable MachineController controller);
		public default boolean preProcess(MachineController controller) { return false; }
		public default boolean postProcess(MachineController controller) { return false; }
