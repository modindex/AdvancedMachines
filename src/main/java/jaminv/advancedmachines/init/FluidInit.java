...
public class FluidInit {
	...
	public static final FluidBase RESIN = (FluidBase)new FluidBase("tree_resin",
			new ResourceLocation(Reference.MODID, "fluids/resin_still"),
			new ResourceLocation(Reference.MODID, "fluids/resin_flow")
		).setMaterial(new MaterialLiquid(MapColor.BROWN))
	...
	public static void registerFluids() {
		...
		FluidRegistry.addBucketForFluid(RESIN);
	}			
}
